...
Security fixes are provided for the latest Marketplace pre-release.
...
vsCodex intentionally has no direct ChatGPT HTTP backend, API-key authentication, token parser, workspace cwd exposure, or Codex-owned tool execution path.
