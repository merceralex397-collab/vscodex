...
- update to the latest CodexVS pre-release;
- confirm a stable Codex CLI 0.144.4 or newer is installed on the extension host;
- run **Codex: Check App-server Runtime** and **Codex: Show Integration Diagnostics**;
- remove prompts, tool data, credentials, authentication URLs, email addresses, and private filesystem paths.
