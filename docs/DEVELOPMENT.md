...
The expected artifact is `vscodex-0.2.1-pre-release.vsix`. Package inspection checks identity, forbidden capabilities and credentials, the MIT license, bundled dependency notices, and the exact package allowlist.
